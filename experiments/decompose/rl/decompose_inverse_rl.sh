#!/usr/bin/env bash
# GRPO on top of the decompose-SFT checkpoint, using the 50/50 regular+inverse RL split.
set -euo pipefail

PROJECT_NAME="simpleqa_decompose_inverse_grpo"
EXPERIMENT_NAME="binary_decompose_inverse"

# Reuse the same SFT checkpoint as the decompose RL experiment.
SFT_PROJECT="simpleqa_decompose_sft"
...
TRAIN_DATA="/work/hdd/bbsg/twei2/rl/verl/data/simpleqa/partition/decompose/inverse/rl/train.parquet"
EVAL_DATA="/work/hdd/bbsg/twei2/rl/verl/data/simpleqa/partition/decompose/inverse/rl/train_eval.parquet /work/hdd/bbsg/twei2/rl/verl/data/simpleqa/partition/decompose/inverse/rl/val.parquet"
