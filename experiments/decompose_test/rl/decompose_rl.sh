#!/usr/bin/env bash
# GRPO on top of the decompose-SFT checkpoint, using the decompose RL split.
set -euo pipefail

PROJECT_NAME="simpleqa_decompose_grpo_test"
EXPERIMENT_NAME="binary_decompose"

# Resolve the most recent SFT checkpoint produced by experiments/decompose/sft/train_sft.sh.
...
SFT_PROJECT="simpleqa_decompose_sft_test"
