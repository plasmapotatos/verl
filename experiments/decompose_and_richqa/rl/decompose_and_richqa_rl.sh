#!/usr/bin/env bash
# GRPO on top of the decompose_and_richqa-SFT checkpoint, using the combined RL split.
set -euo pipefail

PROJECT_NAME="simpleqa_decompose_and_richqa_grpo"
EXPERIMENT_NAME="binary_decompose_and_richqa"
...
SFT_PROJECT="simpleqa_decompose_and_richqa_sft"
...
TRAIN_DATA="/work/hdd/bbsg/twei2/rl/verl/data/simpleqa/partition/decompose_and_richqa/rl/train.parquet"
EVAL_DATA="/work/hdd/bbsg/twei2/rl/verl/data/simpleqa/partition/decompose_and_richqa/rl/train_eval.parquet /work/hdd/bbsg/twei2/rl/verl/data/simpleqa/partition/decompose_and_richqa/rl/val.parquet"
