...
PROJECT_NAME="simpleqa_refusal_clean_richqa_50_50_grpo"
EXPERIMENT_NAME="binary_refusal_clean_richqa_50_50"

SFT_PROJECT="simpleqa_refusal_clean_richqa_50_50_sft"
...
DATA_DIR="/work/hdd/bbsg/twei2/rl/verl/data/simpleqa/augment/refusal_clean/rl"

TRAIN_DATA="$DATA_DIR/train_richqa_rl_combined.parquet"
EVAL_DATA="$DATA_DIR/train_richqa_answer_origqa_frac0.8_frac0.2.parquet $DATA_DIR/train_richqa_answer_origqa_frac0.2.parquet $DATA_DIR/train_richqa_refusal_origqa_frac0.8_frac0.2.parquet $DATA_DIR/train_richqa_refusal_origqa_frac0.2.parquet"
