...
PROJECT_NAME="simpleqa_refusal_clean_grpo"
EXPERIMENT_NAME="binary_refusal_clean"

SFT_PROJECT="simpleqa_refusal_clean_sft"
...
TRAIN_DATA="$DATA_DIR/rl/train.parquet"
EVAL_DATA="$DATA_DIR/rl/train_eval_answer.parquet $DATA_DIR/rl/train_eval_refusal.parquet $DATA_DIR/rl/val_answer.parquet $DATA_DIR/rl/val_refusal.parquet"
