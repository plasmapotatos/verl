...
PROJECT_NAME="simpleqa_decompose_and_richqa_capped_k2_grpo"
EXPERIMENT_NAME="binary_decompose_and_richqa_capped_k2"

SFT_PROJECT="simpleqa_decompose_and_richqa_capped_k2_sft"
