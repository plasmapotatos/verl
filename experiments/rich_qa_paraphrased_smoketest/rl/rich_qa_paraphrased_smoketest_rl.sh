...
PROJECT_NAME="simpleqa_rich_qa_paraphrased_smoketest_grpo"
EXPERIMENT_NAME="binary_rich_qa_paraphrased_smoketest"
...
DATA_DIR="/work/hdd/bbsg/twei2/rl/verl/data/simpleqa/partition/rich_qa/rl/paraphrased/smoketest"
