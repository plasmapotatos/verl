...
PROJECT_NAME="richqa_rpp"
EXPERIMENT_NAME="richqa_rpp"

MODEL_PATH="/work/hdd/bbsg/twei2/rl/verl/outputs/sft/richqa/sft_lr1.5e-4_epmax30_seed1/global_step_1290/merged_hf_model"
...
RUN_EVAL=1 \
SKIP_TRAIN=0 \
bash /work/hdd/bbsg/twei2/rl/verl/experiments/rl/rpp.sh
