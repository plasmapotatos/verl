...
EXPERIMENT_NAME="binary_unbracketed_question_original"

MODEL_PATH="/work/hdd/bbsg/twei2/rl/verl/outputs/sft/simpleqa_factual_anchor_sft_unbracketed_question_original/sft_lr1.5e-4_epmax30_seed1/global_step_570/merged_hf_model"
